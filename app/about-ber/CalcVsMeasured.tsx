...
export default function CalcVsMeasured() {
  return (
    <div className='bg-light/95 text-[var(--body-color)]'>
      <div className='cont py-24 '>
        ...
        <div className='flex flex-col border border-dark bg-neutral-200 rounded-lg shadow-sm md:justify-center lg:flex-row'>
          <div className='flex flex-col justify-between border-b p-10 sm:p-16 lg:border-b-0 lg:border-r-2-black lg:w-1/2'>
            <div>
              ...
              <p className='mt-6 mb-2 p1 font-semibold tracking-wide text-acc2'>
                Key features include:
              </p>
              <ul className='prose list-disc prose-li:marker:text-dark/75 prose-li:p2'>
                <li>
