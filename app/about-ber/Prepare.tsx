...
export default function Prepare() {
  return (
    <div className='text-[var(--body-color)] bg-neutral-200'>
      <div className='cont py-24'>
        <div className='max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-24'>
          <div>
            <p className='inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-[var(--text-color)] uppercase rounded-full bg-indigo-700'>
        ...
        <div className='grid max-w-md gap-8 row-gap-10 sm:mx-auto lg:max-w-full lg:grid-cols-2'>
          <div className='flex flex-col sm:flex-row'>
            <div>
              ...
              <ul className='mb-4 -ml-1 space-y-2 p2 text-[var(--body-color)] mt-5'>
