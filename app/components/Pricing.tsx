        ...
        <div className='flex flex-col lg:flex-row-reverse'>
          ...
          <div className='lg:w-1/2 text-dark/60'>
            ...
            <p className='p1 leading-relaxed mt-8 '>
              ...
              <span className='font-bold'>size of the property</span>, with{" "}
              <span className='font-bold'>
                larger properties generally costing more
              </span>{" "}
              to assess.
            </p>
            ...
            <p className='p1 leading-relaxed mt-8 '>
              ...
              and €325. However,{" "}
              <span className="font-bold">please note that these prices are approximate</span> and may
              vary depending on the specific needs of your property.
            </p>
            <p className='p1 leading-relaxed mt-8'>
