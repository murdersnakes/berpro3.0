          ...
          return (
            <Link key={post.id} href={`/blog/${post.slug}`} className='group'>
              <div className='flex items-center'>
                ...
                />
                <div className='pl-3'>
                  <h3 className='h4 text-sm line-clamp-2 text-dark/50 group-hover:text-[var(--body-color)] transition-colors duration-300'>
                    {post.title}
                  </h3>
                  <p className='p3 line-clamp-2 text-dark/50 group-hover:text-[var(--body-color)] transition-colors duration-300'>
                    {post.excerpt}
                  </p>
                </div>
              </div>
